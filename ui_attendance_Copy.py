...
################################################################################
## Form generated from reading UI file 'attendance - CopyJtiKDW.ui'
##
...
class Ui_Attendance(object):
    def setupUi(self, Attendance):
        ...
        Attendance.setMaximumSize(QSize(1280, 2000))
        font = QFont()
        ...
        self.attendanceWidget.setMaximumSize(QSize(16777215, 16777215))
        self.verticalLayout_8 = QVBoxLayout(self.attendanceWidget)
...
"border-top-left-radius: 5px;")
        ...
        self.verticalLayout_8.addWidget(self.panel_window)
...
"padding-right: 20px;")
        ...
        self.recognize_tab_1_btn.setMaximumSize(QSize(150, 16777215))
...
"border-radius: 5px;")
        ...
        self.recognize_tab_2_btn.setMaximumSize(QSize(150, 16777215))
...
"border-radius: 5px;")
        ...
        self.recognize_tab_3_btn.setMaximumSize(QSize(150, 16777215))
...
"background-color: rgb(0, 170, 255);")
        ...
        self.recognize_keep_btn.setGeometry(QRect(680, 20, 150, 30))
...
"background-color: rgb(0, 255, 64);")
        ...
        self.trainning_popup = QCustomSlideMenu(self.attendanceWidget)
        self.trainning_popup.setObjectName(u"trainning_popup")
        self.trainning_popup.setMinimumSize(QSize(800, 0))
        self.trainning_popup.setMaximumSize(QSize(800, 680))
        self.trainning_popup.setStyleSheet(u"background-color: rgb(255, 0, 0);")

        self.verticalLayout_8.addWidget(self.trainning_popup)
